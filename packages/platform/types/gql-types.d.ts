...
export type ActivateMerchantShopPayload = {
  __typename?: 'ActivateMerchantShopPayload';
  shop: Shop;
};
...
export type AddWishlistItemsInput = {
  ...
  items: Array<InputMaybe<WishlistItemInput>>;
  /** The wishlist ID */
  wishlistId: Scalars['ID'];
};

/** The payload returned from the `addWishlistItems` mutation call */
export type AddWishlistItemsPayload = {
  __typename?: 'AddWishlistItemsPayload';
  /** The same string you sent with the mutation params, for matching mutation calls with their responses */
  clientMutationId: Maybe<Scalars['String']>;
  /**
   * Clients should check to see if any items failed to be added due to the price not matching the current price.
...
export type AddressInput = {
  ...
  /** Region. For example, a U.S. state */
  region: Scalars['String'];
  testInput: InputMaybe<Scalars['String']>;
};
...
/** Data needed to process Afterpay payment */
export type AfterpayPaymentData = {
  __typename?: 'AfterpayPaymentData';
  /** Date of birth of customer if customer is not a company */
...
export type BancontactPaymentData = {
  __typename?: 'BancontactPaymentData';
  /**
   * URL to which a customer is redirected after completing a payment.
   * The URL might contain "{orderId}" placeholder which will be replaced by the real order id.
   * Example: https://storefront.example/checkout/complete?${orderId}
   */
  returnURL: Maybe<Scalars['String']>;
  /** An alternative return URL for transactions that have been cancelled by the customer */
  returnURLCancel: Maybe<Scalars['String']>;
  /** An alternative return URL for transactions that generate an error during processing */
  returnURLError: Maybe<Scalars['String']>;
  /** An alternative return URL for transactions that have been rejected */
  returnURLReject: Maybe<Scalars['String']>;
};
...
export type Blog = {
  ...
  blog_categories: Maybe<Array<Maybe<BlogCategory>>>;
  created_at: Scalars['DateTime'];
  i_18_n_locale: Maybe<I18NLocale>;
  id: Scalars['ID'];
  published_at: Maybe<Scalars['DateTime']>;
  updated_at: Scalars['DateTime'];
};
...
export type BlogBlog_CategoriesArgs = {
...
export type BlogCategoryConnectionBlog = {
  __typename?: 'BlogCategoryConnectionBlog';
  connection: Maybe<BlogCategoryConnection>;
  key: Maybe<Scalars['ID']>;
};

export type BlogCategoryConnectionCreated_At = {
  __typename?: 'BlogCategoryConnectionCreated_at';
  connection: Maybe<BlogCategoryConnection>;
  key: Maybe<Scalars['DateTime']>;
};

export type BlogCategoryConnectionI_18_N_Locale = {
  __typename?: 'BlogCategoryConnectionI_18_n_locale';
  connection: Maybe<BlogCategoryConnection>;
  key: Maybe<Scalars['ID']>;
};
...
export type BlogCategoryConnectionUpdated_At = {
...
export type BlogCategoryGroupBy = {
  ...
  Title: Maybe<Array<Maybe<BlogCategoryConnectionTitle>>>;
  blog: Maybe<Array<Maybe<BlogCategoryConnectionBlog>>>;
  created_at: Maybe<Array<Maybe<BlogCategoryConnectionCreated_At>>>;
  i_18_n_locale: Maybe<Array<Maybe<BlogCategoryConnectionI_18_N_Locale>>>;
  id: Maybe<Array<Maybe<BlogCategoryConnectionId>>>;
  published_at: Maybe<Array<Maybe<BlogCategoryConnectionPublished_At>>>;
  updated_at: Maybe<Array<Maybe<BlogCategoryConnectionUpdated_At>>>;
};
...
export type BlogCategoryInput = {
  ...
  created_by: InputMaybe<Scalars['ID']>;
  i_18_n_locale: InputMaybe<Scalars['ID']>;
  published_at: InputMaybe<Scalars['DateTime']>;
  updated_by: InputMaybe<Scalars['ID']>;
};
...
export type BlogConnectionBody = {
  __typename?: 'BlogConnectionBody';
...
export type BlogConnectionI_18_N_Locale = {
  __typename?: 'BlogConnectionI_18_n_locale';
  connection: Maybe<BlogConnection>;
  key: Maybe<Scalars['ID']>;
};
...
export type BlogGroupBy = {
  ...
  Body: Maybe<Array<Maybe<BlogConnectionBody>>>;
  Title: Maybe<Array<Maybe<BlogConnectionTitle>>>;
  created_at: Maybe<Array<Maybe<BlogConnectionCreated_At>>>;
  i_18_n_locale: Maybe<Array<Maybe<BlogConnectionI_18_N_Locale>>>;
  id: Maybe<Array<Maybe<BlogConnectionId>>>;
  published_at: Maybe<Array<Maybe<BlogConnectionPublished_At>>>;
...
export type BrandAggregator = {
  ...
  avg: Maybe<BrandAggregatorAvg>;
  count: Maybe<Scalars['Int']>;
  max: Maybe<BrandAggregatorMax>;
  min: Maybe<BrandAggregatorMin>;
  sum: Maybe<BrandAggregatorSum>;
  totalCount: Maybe<Scalars['Int']>;
};

export type BrandAggregatorAvg = {
  __typename?: 'BrandAggregatorAvg';
  ranking: Maybe<Scalars['Float']>;
};

export type BrandAggregatorMax = {
  __typename?: 'BrandAggregatorMax';
  ranking: Maybe<Scalars['Float']>;
};

export type BrandAggregatorMin = {
  __typename?: 'BrandAggregatorMin';
  ranking: Maybe<Scalars['Float']>;
};

export type BrandAggregatorSum = {
  __typename?: 'BrandAggregatorSum';
  ranking: Maybe<Scalars['Float']>;
};
...
export type BrandConnectionLogo = {
  __typename?: 'BrandConnectionLogo';
  connection: Maybe<BrandConnection>;
  key: Maybe<Scalars['ID']>;
};
...
export type BrandConnectionPublished_At = {
  __typename?: 'BrandConnectionPublished_at';
  connection: Maybe<BrandConnection>;
  key: Maybe<Scalars['DateTime']>;
};

export type BrandConnectionRanking = {
  __typename?: 'BrandConnectionRanking';
  connection: Maybe<BrandConnection>;
...
export type BrandGroupBy = {
  ...
  logo: Maybe<Array<Maybe<BrandConnectionLogo>>>;
  name: Maybe<Array<Maybe<BrandConnectionName>>>;
  published_at: Maybe<Array<Maybe<BrandConnectionPublished_At>>>;
  ranking: Maybe<Array<Maybe<BrandConnectionRanking>>>;
...
/** Data needed to process payment methods defined in the BukarooPayment` */
export type BuckarooPaymentData = {
  __typename?: 'BuckarooPaymentData';
  ...
  /** Service Used, paypal, mastercard etc */
...
export type ChannelInfo = {
  ...
  channel_market: Maybe<Scalars['String']>;
  /** The country of the Channel */
  country: Maybe<Scalars['String']>;
  /** The error result of the Request */
  errors: Maybe<Scalars['String']>;
  /** The extra info of the Channel */
  extraInfo: Maybe<Array<Maybe<ChannelMap>>>;
  /** The mapping of the Channel */
  mapping: Maybe<Array<Maybe<ChannelMap>>>;
...
export type ComponentGlobalHero = {
  __typename?: 'ComponentGlobalHero';
  id: Scalars['ID'];
  media: Maybe<UploadFile>;
  title: Maybe<Scalars['String']>;
};

export type ComponentGlobalHeroInput = {
  media: InputMaybe<Scalars['ID']>;
  title: InputMaybe<Scalars['String']>;
};

export type ComponentGlobalNavigationService = {
  __typename?: 'ComponentGlobalNavigationService';
  id: Scalars['ID'];
  service_categories: Maybe<Array<Maybe<ServiceCategory>>>;
};


export type ComponentGlobalNavigationServiceService_CategoriesArgs = {
  limit: InputMaybe<Scalars['Int']>;
  sort: InputMaybe<Scalars['String']>;
  start: InputMaybe<Scalars['Int']>;
  where: InputMaybe<Scalars['JSON']>;
...
export type ComponentGlobalNavigationServiceInput = {
  service_categories: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
};

export type ComponentGlobalServicePromo = {
  __typename?: 'ComponentGlobalServicePromo';
  id: Scalars['ID'];
  image: Maybe<UploadFile>;
  promolink: Maybe<ComponentSharedCtaButton>;
  subtitle: Maybe<Scalars['String']>;
  title: Maybe<Scalars['String']>;
};

export type ComponentGlobalServicePromoInput = {
  image: InputMaybe<Scalars['ID']>;
  promolink: InputMaybe<ComponentSharedCtaButtonInput>;
  subtitle: InputMaybe<Scalars['String']>;
  title: InputMaybe<Scalars['String']>;
};

export type ComponentGlobalServiceQuick = {
  __typename?: 'ComponentGlobalServiceQuick';
  id: Scalars['ID'];
  services: Maybe<Array<Maybe<Services>>>;
};


export type ComponentGlobalServiceQuickServicesArgs = {
  limit: InputMaybe<Scalars['Int']>;
  sort: InputMaybe<Scalars['String']>;
  start: InputMaybe<Scalars['Int']>;
  where: InputMaybe<Scalars['JSON']>;
...
export type ComponentGlobalServiceQuickInput = {
  services: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
};

export type ComponentSharedCtaButton = {
  __typename?: 'ComponentSharedCtaButton';
...
export type ComponentSharedCtaButtonInput = {
  icon: InputMaybe<Scalars['String']>;
  link: ComponentSharedLinkInput;
...
export type CreateTaxRateInput = {
  /** If true, all prices of products, shipping, surcharges etc. have tax included */
  afterTaxPricing: InputMaybe<Scalars['Boolean']>;
  /** An optional string identifying the mutation call, which will be returned in the response payload */
  clientMutationId: InputMaybe<Scalars['String']>;
...
export type CreditcardPaymentData = {
  __typename?: 'CreditcardPaymentData';
  /**
   * URL to which a customer is redirected after completing a payment.
   * The URL might contain "{orderId}" placeholder which will be replaced by the real order id.
   * Example: https://storefront.example/checkout/complete?${orderId}
...
export type Cronupdate = {
  /** The cron time the feed needs to be ran */
  crontxt: Scalars['String'];
  /** The id of the cron */
  feedId: Scalars['Int'];
  /** The id of the shop */
...
export type ExportFeed = {
  __typename?: 'ExportFeed';
  /** The Id of the Channel */
  channel: Scalars['Int'];
  /** The companyId of the user */
  companyId: Scalars['String'];
  /** The cron text the feed needs to be ran */
  crontxt: Maybe<Scalars['String']>;
  /** The currency state of the feed */
  currency: Maybe<CurrencyStock>;
  ...
  loopon: Maybe<Scalars['String']>;
  /** The mapped fields of the the export feed */
  mapfieldcount: Maybe<Scalars['Int']>;
  /** The amount of fiels of the the export feed */
  mapfields: Maybe<Scalars['Int']>;
  ...
  title: Maybe<Scalars['String']>;
  /** The token of the feeds */
  token: Maybe<Scalars['String']>;
  /** The seconds the feed took to generate */
  tookSeconds: Maybe<Scalars['Float']>;
...
/** Get the counting of the feed */
export type FeedCount = {
  __typename?: 'FeedCount';
  /** Data of the feedcounting */
  data: Scalars['String'];
  /** The feedId */
  feedId: Scalars['Int'];
};
...
export type FeedCounts = {
  __typename?: 'FeedCounts';
  /** The amount found of the feed counts */
  count: Maybe<Scalars['Int']>;
  /** The error result of the feed counts */
  errors: Maybe<Scalars['String']>;
  /** The feedId of the feed counts */
  feedId: Maybe<Scalars['Int']>;
  /** The inserted amount of the feed counts */
  inserted: Maybe<Scalars['Int']>;
  /** The last run date of the feed */
  lastrun: Maybe<Scalars['String']>;
  /** The status feed counts */
...
export type FeedInput = {
  ...
  currency: InputMaybe<CurrencyStock>;
  /** The id of the shop */
  shopId: Scalars['String'];
...
export enum FiletypetypeImport {
  /** comma-separated values */
  Csv = 'csv',
  /** extensible markup language */
  Xml = 'xml'
...
/** The rule connection type */
export type FilterFields = {
  /** The field you want to search on */
  field: InputMaybe<Scalars['String']>;
  /** The searchstring to search on */
...
export type GetRuleIndex = {
  ...
  feedId: Scalars['Int'];
  /** filter the items on rules */
  ruleindex: Scalars['Int'];
...
export type IdealPaymentData = {
  __typename?: 'IdealPaymentData';
  /** BIC code of the issuing bank of the consumer */
  issuer: IssuingBankBic;
  /**
   * URL to which a customer is redirected after completing a payment.
   * The URL might contain "{orderId}" placeholder which will be replaced by the real order id.
   * Example: https://storefront.example/checkout/complete?${orderId}
...
export type ImportResult = {
  ...
  /** The possible errors of the ImportResult */
  errors: Maybe<Scalars['String']>;
...
/** The stats for an input */
export type InputStats = {
  /** Import or export feeds */
  channel: Feedtype;
...
export type ItemFilter = {
  ...
  /** filter the items on rules */
  rulesindex: InputMaybe<GetRuleIndex>;
...
export type ItemResult = {
  ...
  /** The beforeCount of the rules of the ItemResult */
  beforeCount: Maybe<Scalars['Int']>;
  /** The possible errors of the ItemResult */
  errors: Maybe<Scalars['String']>;
...
export type Items = {
  ...
  DJS_created: Maybe<Scalars['String']>;
  /** The importfeed id of the item */
  DJS_feedId: Maybe<Scalars['Int']>;
  /** The modified date of the item */
  DJS_modified: Maybe<Scalars['String']>;
  /** The last status change of the item */
  DJS_status: Maybe<Scalars['String']>;
  ...
  /** The full JSON of the item */
  fullJSON: Maybe<Scalars['String']>;
  /** The id of the item */
...
export type JsonRules = {
  __typename?: 'JsonRules';
  /** The json string to save */
  jsonRules: Maybe<Scalars['String']>;
};
...
export type MerchantCommission = {
  ...
  /** Commision rate for completed orders */
  completed: Scalars['Float'];
  /** Commision rate for orders that wasn't delivered */
  notDelivered: Scalars['Float'];
  /** Commision rate for returned orders */
  returned: Scalars['Float'];
};

/** Different commission rates for orders with specific status */
export type MerchantCommissionInput = {
  /** Commision rate for completed orders */
  completed: InputMaybe<Scalars['Float']>;
  /** Commision rate for orders that wasn't delivered */
  notDelivered: InputMaybe<Scalars['Float']>;
  /** Commision rate for returned orders */
...
export type Morph = Bearer | Blog | BlogAggregator | BlogCategory | BlogCategoryAggregator | BlogCategoryConnection | BlogCategoryConnectionBlog | BlogCategoryConnectionCreated_At | BlogCategoryConnectionI_18_N_Locale | BlogCategoryConnectionId | BlogCategoryConnectionPublished_At | BlogCategoryConnectionTitle | BlogCategoryConnectionUpdated_At | BlogCategoryGroupBy | BlogConnection | BlogConnectionBody | BlogConnectionCreated_At | BlogConnectionI_18_N_Locale | BlogConnectionId | BlogConnectionPublished_At | BlogConnectionTitle | BlogConnectionUpdated_At | BlogGroupBy | Brand | BrandAggregator | BrandAggregatorAvg | BrandAggregatorMax | BrandAggregatorMin | BrandAggregatorSum | BrandConnection | BrandConnectionCreated_At | BrandConnectionDescription | BrandConnectionId | BrandConnectionLogo | BrandConnectionName | BrandConnectionPublished_At | BrandConnectionRanking | BrandConnectionUpdated_At | BrandGroupBy | ComponentGlobalHero | ComponentGlobalNavigationService | ComponentGlobalServicePromo | ComponentGlobalServiceQuick | ComponentSharedCtaButton | ComponentSharedLink | I18NLocale | Page | PageAggregator | PageConnection | PageConnectionBody | PageConnectionCreated_At | PageConnectionId | PageConnectionPublished_At | PageConnectionUpdated_At | PageGroupBy | ServiceCategory | ServiceCategoryAggregator | ServiceCategoryConnection | ServiceCategoryConnectionCategoryId | ServiceCategoryConnectionCreated_At | ServiceCategoryConnectionHero | ServiceCategoryConnectionIcon | ServiceCategoryConnectionId | ServiceCategoryConnectionLocale | ServiceCategoryConnectionName | ServiceCategoryConnectionUpdated_At | ServiceCategoryGroupBy | ServicePage | Services | ServicesAggregator | ServicesConnection | ServicesConnectionBody | ServicesConnectionCreated_At | ServicesConnectionId | ServicesConnectionLocale | ServicesConnectionPublished_At | ServicesConnectionService_Category | ServicesConnectionSlug | ServicesConnectionTitle | ServicesConnectionUpdated_At | ServicesGroupBy | UploadFile | UploadFileAggregator | UploadFileAggregatorAvg | UploadFileAggregatorMax | UploadFileAggregatorMin | UploadFileAggregatorSum | UploadFileConnection | UploadFileConnectionAlternativeText | UploadFileConnectionCaption | UploadFileConnectionCreated_At | UploadFileConnectionExt | UploadFileConnectionFormats | UploadFileConnectionHash | UploadFileConnectionHeight | UploadFileConnectionId | UploadFileConnectionMime | UploadFileConnectionName | UploadFileConnectionPreviewUrl | UploadFileConnectionProvider | UploadFileConnectionProvider_Metadata | UploadFileConnectionSize | UploadFileConnectionUpdated_At | UploadFileConnectionUrl | UploadFileConnectionWidth | UploadFileGroupBy | UserPermissionsPasswordPayload | UsersPermissionsLoginPayload | UsersPermissionsMe | UsersPermissionsMeRole | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser | CreateBlogCategoryPayload | CreateBlogPayload | CreateBrandPayload | CreatePagePayload | CreateServiceCategoryPayload | CreateServicePayload | DeleteBearerPayload | DeleteBlogCategoryPayload | DeleteBlogPayload | DeleteBrandPayload | DeleteFilePayload | DeletePagePayload | DeleteServiceCategoryPayload | DeleteServicePagePayload | DeleteServicePayload | UpdateBearerPayload | UpdateBlogCategoryPayload | UpdateBlogPayload | UpdateBrandPayload | UpdatePagePayload | UpdateServiceCategoryPayload | UpdateServicePagePayload | UpdateServicePayload;
...
export type Mutation = {
  __typename?: 'Mutation';
  /** Export a cron */
  ExportCron: Maybe<ResultUpdate>;
  /** Delete an export */
  ExportDelete: Maybe<ResultUpdate>;
  /** Insert an export */
  ExportInsert: Maybe<ResultUpdate>;
  /** Start an export */
  ExportStart: Maybe<ResultUpdate>;
  /** Update an export */
  ExportUpdate: Maybe<ResultUpdate>;
  /** Import a cron update */
  ImportCron: Maybe<ResultUpdate>;
  /** Delete an import */
  ImportDelete: Maybe<ResultUpdate>;
  /** Insert an import */
  ImportInsert: Maybe<ResultImport>;
  /** Start an import */
  ...
  SaveMapping: Maybe<ResultUpdate>;
  /** Update the unique of an import */
  UpdateUnique: Maybe<ResultUpdate>;
  /** Activate merchant shop if all attributes of a merchant shop are configured */
  activateMerchantShop: ActivateMerchantShopPayload;
  ...
  createServiceCategoryLocalization: ServiceCategory;
  createServiceLocalization: Services;
  createServicePageLocalization: ServicePage;
  /** Create a new shop */
  ...
  deleteBearer: Maybe<DeleteBearerPayload>;
  ...
  deleteServicePage: Maybe<DeleteServicePagePayload>;
  ...
  generateDraftInvoice: Maybe<Invoice>;
  ...
  removeWishlistItems: RemoveWishlistItemsPayload;
  ...
  saveUserRule: Maybe<ResultUpdate>;
  /** Save a struct */
  saveUserStruct: Maybe<ResultUpdate>;
  ...
  /** Set the billing address address for all fulfillment groups */
  setBillingAddressOnCart: SetBillingAddressOnCartPayload;
  /** Send the PushURL to store in the mongodb  */
  ...
  setShopCommission: SetShopCommissionPayload;
  ...
  updateServicePage: Maybe<UpdateServicePagePayload>;
...
export type MutationExportCronArgs = {
  input: Cronupdate;
};
...
export type MutationExportInsertArgs = {
  input: FeedInput;
};
...
export type MutationImportCronArgs = {
  input: Cronupdate;
};


export type MutationImportDeleteArgs = {
  input: IDfield;
};


export type MutationImportInsertArgs = {
...
export type MutationSaveMappingArgs = {
  input: SaveJsoNexport;
};


export type MutationUpdateUniqueArgs = {
  input: InputMaybe<UniqueField>;
};


export type MutationActivateMerchantShopArgs = {
...
export type MutationAddWishlistItemsArgs = {
...
export type MutationCreateBlogArgs = {
  input: InputMaybe<CreateBlogInput>;
};


export type MutationCreateBlogCategoryArgs = {
  input: InputMaybe<CreateBlogCategoryInput>;
};
...
export type MutationCreateServiceCategoryArgs = {
  input: InputMaybe<CreateServiceCategoryInput>;
};
...
export type MutationCreateServicePageLocalizationArgs = {
  input: UpdateServicePageInput;
};
...
export type MutationDeleteBlogArgs = {
  input: InputMaybe<DeleteBlogInput>;
};


export type MutationDeleteBlogCategoryArgs = {
  input: InputMaybe<DeleteBlogCategoryInput>;
};
...
export type MutationDeleteServiceArgs = {
  input: InputMaybe<DeleteServiceInput>;
};


export type MutationDeleteServiceCategoryArgs = {
  input: InputMaybe<DeleteServiceCategoryInput>;
};
...
export type MutationGenerateDraftInvoiceArgs = {
...
export type MutationRemoveWishlistItemsArgs = {
...
export type MutationSaveUserRuleArgs = {
  input: SaveJson;
};


export type MutationSaveUserStructArgs = {
  input: SaveStruct;
};
...
export type MutationSetBuckarooCallbackDataArgs = {
  input: Transaction;
};
...
export type MutationSetShopCommissionArgs = {
  input: SetShopCommissionInput;
};
...
export type MutationUpdateBlogArgs = {
  input: InputMaybe<UpdateBlogInput>;
};


export type MutationUpdateBlogCategoryArgs = {
  input: InputMaybe<UpdateBlogCategoryInput>;
};
...
export type MutationUpdateMerchantShopArgs = {
  input: UpdateMerchantShopInput;
};


export type MutationUpdateMerchantShopInvoiceSettingsArgs = {
  input: UpdateMerchantShopInvoiceSettingsInput;
};
...
export type MutationUpdateServiceCategoryArgs = {
  input: InputMaybe<UpdateServiceCategoryInput>;
};


export type MutationUpdateServicePageArgs = {
  input: InputMaybe<UpdateServicePageInput>;
  locale: InputMaybe<Scalars['String']>;
};
...
export enum OrderPaymentStatus {
  ...
  Created = 'created',
  /** Payment needs to be completed from external payment system */
  Pending = 'pending'
}
...
export enum OrderStatus {
  ...
  New = 'new',
  /** Order awaits payment to be completed before going to status new */
...
export type PackagePlan = Node & {
  __typename?: 'PackagePlan';
  /** Id of the package plan */
  _id: Scalars['ID'];
  /** Name of the package plan */
  name: Scalars['String'];
  price: Money;
  /** The max amount of products allowed for the merchant to create */
  productAmount: Maybe<Scalars['Int']>;
  /** The max amount of stock allowed for the merchant to create */
  stockAmount: Maybe<Scalars['Int']>;
};

/**
 * Wraps a list of `PackagePlans`, providing pagination cursors and information.
 *
 * For information about what Relay-compatible connections are and how to use them, see the following articles:
 * - [Relay Connection Documentation](https://facebook.github.io/relay/docs/en/graphql-server-specification.html#connections)
 * - [Relay Connection Specification](https://facebook.github.io/relay/graphql/connections.htm)
 * - [Using Relay-style Connections With Apollo Client](https://www.apollographql.com/docs/react/recipes/pagination.html)
 */
export type PackagePlanConnection = {
  __typename?: 'PackagePlanConnection';
  /** The list of nodes that match the query, wrapped in an edge to provide a cursor string for each */
  edges: Maybe<Array<Maybe<PackagePlanEdge>>>;
  /**
   * You can request the `nodes` directly to avoid the extra wrapping that `NodeEdge` has,
   * if you know you will not need to paginate the results.
   */
  nodes: Maybe<Array<Maybe<PackagePlan>>>;
  /** Information to help a client request the next or previous page */
  pageInfo: PageInfo;
  /** The total number of nodes that match your query */
  totalCount: Scalars['Int'];
...
/** A connection edge in which each node is an `PackagePlan` object */
export type PackagePlanEdge = NodeEdge & {
  __typename?: 'PackagePlanEdge';
  /** The cursor that represents this node in the paginated results */
  cursor: Scalars['ConnectionCursor'];
  /** The package plan */
  node: Maybe<PackagePlan>;
};
...
export type PageConnectionBody = {
  __typename?: 'PageConnectionBody';
...
export type PageGroupBy = {
  ...
  Body: Maybe<Array<Maybe<PageConnectionBody>>>;
...
export type PaymentData = AfterpayPaymentData | BancontactPaymentData | CreditcardPaymentData | ExampleIouPaymentData | FakeData | IdealPaymentData | PaypalPaymentData | StripeCardPaymentData;
...
export enum PaymentStatus {
  ...
  /**
   * Upon placing an order, the status of all payments for that order that need
   * additional action begins at 'pending'
   */
  Pending = 'pending',
...
export type Query = {
  ...
  GetStats: Maybe<Array<Maybe<StatsInfo>>>;
  /** Get struct of the feed */
  GetStruct: Maybe<ResultStruct>;
  /** Get import feed */
  ImportFeed: ImportResult;
  ...
  packagePlans: Maybe<PackagePlanConnection>;
  page: Maybe<Page>;
  ...
  serviceCategoriesConnection: Maybe<ServiceCategoryConnection>;
  ...
  wishlistByAccountId: Maybe<Wishlist>;
};


export type QueryCountRulesArgs = {
  input: SaveJson;
};


export type QueryExportFeedArgs = {
  input: InputMaybe<IDfields>;
};
...
export type QueryGetChannelsCategoryArgs = {
  input: InputMaybe<ChannelId>;
};


export type QueryGetFeedProcessArgs = {
  channel: InputMaybe<InputStats>;
};


export type QueryGetItemsArgs = {
  input: InputMaybe<ItemFilter>;
};


export type QueryGetItemsCategoryArgs = {
  input: ShopInput;
};
...
export type QueryGetStatsArgs = {
  input: InputMaybe<InputStats>;
};


export type QueryGetStructArgs = {
  input: ShopInput;
};


export type QueryImportFeedArgs = {
  input: InputMaybe<IDfields>;
};
...
export type QueryPackagePlansArgs = {
  after: InputMaybe<Scalars['ConnectionCursor']>;
  before: InputMaybe<Scalars['ConnectionCursor']>;
  first: InputMaybe<Scalars['ConnectionLimitInt']>;
  last: InputMaybe<Scalars['ConnectionLimitInt']>;
...
export type QueryWishlistByAccountIdArgs = {
  accountId: Scalars['ID'];
  shopId: Scalars['ID'];
};
...
export type RemoveWishlistItemsInput = {
  /** An optional string identifying the mutation call, which will be returned in the response payload */
  clientMutationId: InputMaybe<Scalars['String']>;
  /** The wishlist ID */
  wishlistId: Scalars['ID'];
  /** Array of items to remove from the wishlist. */
  wishlistItemIds: Array<InputMaybe<Scalars['ID']>>;
};

/** The payload returned from the `removeWishlistItems` mutation call */
export type RemoveWishlistItemsPayload = {
  __typename?: 'RemoveWishlistItemsPayload';
  /** The same string you sent with the mutation params, for matching mutation calls with their responses */
  clientMutationId: Maybe<Scalars['String']>;
...
export type ResultChannelInfo = {
  ...
  /** The possible errors of the Channel Info */
  errors: Maybe<Scalars['String']>;
...
export type RuleConnection = {
  ...
  /** The edges containing the user mapping */
  edges: Maybe<Array<Maybe<UserMap>>>;
  /** The pageinfo of the rule connection */
  pageInfo: PageInfo;
};

/** The rule index input */
...
export type RulesInfo = {
  __typename?: 'RulesInfo';
  /** The Rule paging of the requested rules */
  RuleConnect: Maybe<RuleConnection>;
  /** The possible errors of the requested rules */
  errors: Maybe<Scalars['String']>;
  /** The total count of the requested rules */
  totalCount: Maybe<Scalars['Int']>;
};


/** The rules info type */
export type RulesInfoRuleConnectArgs = {
...
export type SaveJsoNexport = {
  /** The CDNimage of this input */
  CDNimage: InputMaybe<Scalars['String']>;
  /** The attributes json of this input */
  attributes: InputMaybe<Scalars['String']>;
  /** The Category Separator of this input */
  categorySeparator: InputMaybe<Scalars['String']>;
  /** import or export of the channel */
  channel: Feedtype;
  /** The description of this input */
  description: InputMaybe<Scalars['String']>;
  /** The domain of this input */
  domain: InputMaybe<Scalars['String']>;
  /** FeedID to update */
  feedId: Scalars['Int'];
  /** The groupby of this input */
...
export type SaveStruct = {
  ...
  shopId: Scalars['String'];
  /** The json string to save */
  struct: InputMaybe<Array<InputMaybe<StructList>>>;
};
...
export type ServiceCategory = {
  ...
  categoryId: Maybe<Scalars['String']>;
  created_at: Scalars['DateTime'];
  hero: Maybe<ComponentGlobalHero>;
  icon: Maybe<Scalars['String']>;
  id: Scalars['ID'];
  locale: Maybe<Scalars['String']>;
  localizations: Maybe<Array<Maybe<ServiceCategory>>>;
  services: Maybe<Array<Maybe<Services>>>;
  updated_at: Scalars['DateTime'];
};
...
export type ServiceCategoryAggregator = {
  __typename?: 'ServiceCategoryAggregator';
  count: Maybe<Scalars['Int']>;
  totalCount: Maybe<Scalars['Int']>;
};
...
export type ServiceCategoryConnection = {
  ...
  aggregate: Maybe<ServiceCategoryAggregator>;
  groupBy: Maybe<ServiceCategoryGroupBy>;
  values: Maybe<Array<Maybe<ServiceCategory>>>;
};

export type ServiceCategoryConnectionCategoryId = {
  __typename?: 'ServiceCategoryConnectionCategoryId';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['String']>;
};

export type ServiceCategoryConnectionCreated_At = {
  __typename?: 'ServiceCategoryConnectionCreated_at';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['DateTime']>;
};

export type ServiceCategoryConnectionHero = {
  __typename?: 'ServiceCategoryConnectionHero';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['ID']>;
};

export type ServiceCategoryConnectionIcon = {
  __typename?: 'ServiceCategoryConnectionIcon';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['String']>;
};

export type ServiceCategoryConnectionId = {
  __typename?: 'ServiceCategoryConnectionId';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['ID']>;
};

export type ServiceCategoryConnectionLocale = {
  __typename?: 'ServiceCategoryConnectionLocale';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['String']>;
};

export type ServiceCategoryConnectionName = {
  __typename?: 'ServiceCategoryConnectionName';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['String']>;
};

export type ServiceCategoryConnectionUpdated_At = {
  __typename?: 'ServiceCategoryConnectionUpdated_at';
  connection: Maybe<ServiceCategoryConnection>;
  key: Maybe<Scalars['DateTime']>;
};

export type ServiceCategoryGroupBy = {
  __typename?: 'ServiceCategoryGroupBy';
  Name: Maybe<Array<Maybe<ServiceCategoryConnectionName>>>;
  categoryId: Maybe<Array<Maybe<ServiceCategoryConnectionCategoryId>>>;
  created_at: Maybe<Array<Maybe<ServiceCategoryConnectionCreated_At>>>;
  hero: Maybe<Array<Maybe<ServiceCategoryConnectionHero>>>;
  icon: Maybe<Array<Maybe<ServiceCategoryConnectionIcon>>>;
  id: Maybe<Array<Maybe<ServiceCategoryConnectionId>>>;
  locale: Maybe<Array<Maybe<ServiceCategoryConnectionLocale>>>;
  updated_at: Maybe<Array<Maybe<ServiceCategoryConnectionUpdated_At>>>;
};
...
export type ServiceCategoryInput = {
  ...
  created_by: InputMaybe<Scalars['ID']>;
  hero: InputMaybe<ComponentGlobalHeroInput>;
  icon: InputMaybe<Scalars['String']>;
  locale: InputMaybe<Scalars['String']>;
...
export type ServiceInput = {
  ...
  localizations: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
  published_at: InputMaybe<Scalars['DateTime']>;
  service_category: InputMaybe<Scalars['ID']>;
  slug: InputMaybe<Scalars['String']>;
  title: InputMaybe<Scalars['String']>;
  updated_by: InputMaybe<Scalars['ID']>;
};
...
export type ServicePage = {
  ...
  id: Scalars['ID'];
  locale: Maybe<Scalars['String']>;
  localizations: Maybe<Array<Maybe<ServicePage>>>;
  navigation: Maybe<ComponentGlobalNavigationService>;
  promo: Maybe<ComponentGlobalServicePromo>;
  published_at: Maybe<Scalars['DateTime']>;
  quickMenu: Maybe<ComponentGlobalServiceQuick>;
  updated_at: Scalars['DateTime'];
};
...
export type ServicePageInput = {
  ...
  locale: InputMaybe<Scalars['String']>;
  localizations: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
  navigation: InputMaybe<ComponentGlobalNavigationServiceInput>;
  promo: InputMaybe<ComponentGlobalServicePromoInput>;
  published_at: InputMaybe<Scalars['DateTime']>;
  quickMenu: InputMaybe<ComponentGlobalServiceQuickInput>;
  updated_by: InputMaybe<Scalars['ID']>;
};
...
export type Services = {
  ...
  id: Scalars['ID'];
  locale: Maybe<Scalars['String']>;
  localizations: Maybe<Array<Maybe<Services>>>;
  published_at: Maybe<Scalars['DateTime']>;
...
export type ServicesLocalizationsArgs = {
  limit: InputMaybe<Scalars['Int']>;
  sort: InputMaybe<Scalars['String']>;
  start: InputMaybe<Scalars['Int']>;
  where: InputMaybe<Scalars['JSON']>;
...
export type ServicesConnectionBody = {
  __typename?: 'ServicesConnectionBody';
...
export type ServicesConnectionLocale = {
  __typename?: 'ServicesConnectionLocale';
  connection: Maybe<ServicesConnection>;
  key: Maybe<Scalars['String']>;
};
...
export type ServicesConnectionService_Category = {
  __typename?: 'ServicesConnectionService_category';
  connection: Maybe<ServicesConnection>;
  key: Maybe<Scalars['ID']>;
};
...
export type ServicesGroupBy = {
  ...
  body: Maybe<Array<Maybe<ServicesConnectionBody>>>;
  created_at: Maybe<Array<Maybe<ServicesConnectionCreated_At>>>;
  id: Maybe<Array<Maybe<ServicesConnectionId>>>;
  locale: Maybe<Array<Maybe<ServicesConnectionLocale>>>;
  published_at: Maybe<Array<Maybe<ServicesConnectionPublished_At>>>;
  service_category: Maybe<Array<Maybe<ServicesConnectionService_Category>>>;
...
/** The response from the `setBillingAddressOnCart` mutation */
export type SetBillingAddressOnCartPayload = {
  __typename?: 'SetBillingAddressOnCartPayload';
  /** The updated Cart */
  cart: Cart;
  /** The same string you sent with the mutation params, for matching mutation calls with their responses */
  clientMutationId: Maybe<Scalars['String']>;
...
export type SetShopCommissionInput = {
  /** Commission rates for the merchant shop */
  commission: MerchantCommissionInput;
  /** Id of the merchant shop */
  merchantShopId: Scalars['ID'];
};

export type SetShopCommissionPayload = {
  __typename?: 'SetShopCommissionPayload';
  shop: Shop;
};
...
export enum StatType {
  /** errors in the feeds */
  Error = 'error',
  /** This shows the mapping of the struct on the feeds */
  MappingStats = 'mappingStats',
  /** This shows the count, categorys and doubles of the feed */
  Stats = 'stats'
}

/** The info statistics results */
...
/** Return Strapi magic link */
export type StrapiLogin = {
  __typename?: 'StrapiLogin';
  /** Strapi link */
  url: Maybe<Scalars['String']>;
};
...
export type Subscription = {
  ...
  /** Get process feed items */
  feedProcess: Maybe<Array<Maybe<FeedCounts>>>;
  /** A test subscription that returns an incremented number every 1 second for 10 seconds */
  tick: Scalars['Int'];
};


export type SubscriptionFeedProcessArgs = {
  channel: InputMaybe<InputStats>;
};
...
export type TaxRate = {
  ...
  _id: Scalars['ID'];
  /** If true, all prices of products, shipping, surcharges etc. have tax included */
  afterTaxPricing: Maybe<Scalars['Boolean']>;
...
export type Transaction = {
  ...
  AmountDebit: InputMaybe<Scalars['Float']>;
  Currency: Scalars['String'];
  CustomParameters: InputMaybe<Scalars['String']>;
  ...
  Key: Scalars['String'];
  MutationType: InputMaybe<Scalars['Int']>;
  Order: InputMaybe<Scalars['String']>;
  PayerHash: InputMaybe<Scalars['String']>;
  PaymentKey: Scalars['String'];
  Recurring: InputMaybe<Scalars['Boolean']>;
  RelatedTransactions: InputMaybe<Scalars['String']>;
  ServiceCode: Scalars['String'];
  Services: InputMaybe<Scalars['String']>;
  StartRecurrent: InputMaybe<Scalars['Boolean']>;
  Status: Scalars['String'];
...
export type UpdateMerchantShopInvoiceSettingsPayload = {
  __typename?: 'UpdateMerchantShopInvoiceSettingsPayload';
  shop: Shop;
};
...
export type UserMap = {
  __typename?: 'UserMap';
  /** The CDNimage of the User mapping */
  CDNimage: Maybe<Scalars['String']>;
  /** The _id of the User mapping */
  _id: Maybe<Scalars['String']>;
  /** The active of the User mapping */
  active: Maybe<Scalars['String']>;
  /** The attributes of the User mapping */
  attributes: Maybe<Scalars['String']>;
  /** The categorySeparator of the User mapping */
  categorySeparator: Maybe<Scalars['String']>;
  /** The channel of the User mapping */
  channel: Feedtype;
  /** The channelId of the User mapping */
  channelId: Maybe<Scalars['Int']>;
  /** The companyId of the User mapping */
  companyId: Scalars['String'];
  /** The count of the User mapping */
  count: Maybe<Scalars['String']>;
  /** The data of the User mapping */
  data: Maybe<Scalars['String']>;
  /** The description of the User mapping */
  description: Maybe<Scalars['String']>;
  /** The domain of the User mapping */
  domain: Maybe<Scalars['String']>;
  /** The id of the User mapping */
  feedId: Scalars['Int'];
  /** The groupby of the User mapping */
  groupBy: Maybe<Scalars['String']>;
  /** The index of the User mapping */
  index: Maybe<Scalars['Int']>;
  /** The name of the User mapping */
  name: Maybe<Scalars['String']>;
  /** The perecenta of the User mapping */
  percent: Maybe<Scalars['Int']>;
  /** The userId of the User mapping */
  userId: Maybe<Scalars['String']>;
};

/** The UserMap result */
export type UserMapResult = {
  __typename?: 'UserMapResult';
  /** The possible errors of the UserMapResult */
  errors: Maybe<Scalars['String']>;
...
export type Wishlist = Node & {
  ...
  items: Maybe<WishlistItemConnection>;
  /**
   ...
   * back to `items`, but clients may want to provide a way for users to manually do this.
   */
  missingItems: Maybe<Array<Maybe<WishlistItem>>>;
...
export type WishlistItemsArgs = {
  ...
  last: InputMaybe<Scalars['ConnectionLimitInt']>;
  offset: InputMaybe<Scalars['Int']>;
  sortBy?: InputMaybe<WishlistItemsSortByField>;
  sortOrder?: InputMaybe<SortOrder>;
};
...
export type WishlistItem = Node & {
   ...
   * options were chosen for some configurable attributes, then `color:blue` and `size:small` will be indicated here.
   */
  attributes: Maybe<Array<Maybe<WishlistItemAttribute>>>;
  /** The current comparison (e.g., MSRP) price of the item */
  compareAtPrice: Maybe<Money>;
  /**
...
/** A single item in a wishlist. The item contains information about an intended purchase. */
export type WishlistItemProductTagsArgs = {
  after: InputMaybe<Scalars['ConnectionCursor']>;
  before: InputMaybe<Scalars['ConnectionCursor']>;
  first: InputMaybe<Scalars['ConnectionLimitInt']>;
  last: InputMaybe<Scalars['ConnectionLimitInt']>;
...
export type WishlistItemAttribute = {
  __typename?: 'WishlistItemAttribute';
  /** The attribute label, e.g., Color */
  label: Maybe<Scalars['String']>;
  /** The attribute value, e.g., Blue */
  value: Maybe<Scalars['String']>;
...
export type WishlistItemConnection = {
   ...
   * if you know you will not need to paginate the results.
   */
  nodes: Maybe<Array<Maybe<WishlistItem>>>;
  /** Information to help a client request the next or previous page */
  pageInfo: PageInfo;
  /** The total number of nodes that match your query */
  totalCount: Scalars['Int'];
...
export type WishlistItemEdge = NodeEdge & {
  __typename?: 'WishlistItemEdge';
  /** The cursor that represents this node in the paginated results */
  cursor: Scalars['ConnectionCursor'];
  /** The wishlist item */
  node: Maybe<WishlistItem>;
};
...
export enum WishlistItemsSortByField {
  /** Wishlist item ID */
  Id = '_id',
...
export type CreateBlogCategoryInput = {
  data: InputMaybe<BlogCategoryInput>;
};
...
export type DeleteBearerPayload = {
  __typename?: 'deleteBearerPayload';
  bearer: Maybe<Bearer>;
};
...
export type EditComponentGlobalHeroInput = {
  id: InputMaybe<Scalars['ID']>;
  media: InputMaybe<Scalars['ID']>;
  title: InputMaybe<Scalars['String']>;
};

export type EditComponentGlobalNavigationServiceInput = {
  id: InputMaybe<Scalars['ID']>;
  service_categories: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
};

export type EditComponentGlobalServicePromoInput = {
  id: InputMaybe<Scalars['ID']>;
  image: InputMaybe<Scalars['ID']>;
  promolink: InputMaybe<EditComponentSharedCtaButtonInput>;
  subtitle: InputMaybe<Scalars['String']>;
  title: InputMaybe<Scalars['String']>;
};

export type EditComponentGlobalServiceQuickInput = {
  id: InputMaybe<Scalars['ID']>;
  services: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
};

export type EditComponentSharedCtaButtonInput = {
  icon: InputMaybe<Scalars['String']>;
  id: InputMaybe<Scalars['ID']>;
  link: InputMaybe<EditComponentSharedLinkInput>;
  text: InputMaybe<Scalars['String']>;
};

export type EditComponentSharedLinkInput = {
...
export type EditJson = {
  /** Range from date of the results */
  channel: Feedtype;
  /** Rules with indexes to update */
  ruleindexes: Array<InputMaybe<Ruleindex>>;
  /** The id of the shop */
  shopId: Scalars['String'];
};
...
export type EditServiceCategoryInput = {
  Name: InputMaybe<Scalars['String']>;
  categoryId: InputMaybe<Scalars['String']>;
  created_by: InputMaybe<Scalars['ID']>;
  hero: InputMaybe<EditComponentGlobalHeroInput>;
  icon: InputMaybe<Scalars['String']>;
  locale: InputMaybe<Scalars['String']>;
  localizations: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
  services: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
...
export type EditServicePageInput = {
  created_by: InputMaybe<Scalars['ID']>;
  hero: InputMaybe<EditComponentGlobalHeroInput>;
  locale: InputMaybe<Scalars['String']>;
  localizations: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
  navigation: InputMaybe<EditComponentGlobalNavigationServiceInput>;
  promo: InputMaybe<EditComponentGlobalServicePromoInput>;
  published_at: InputMaybe<Scalars['DateTime']>;
  quickMenu: InputMaybe<EditComponentGlobalServiceQuickInput>;
  updated_by: InputMaybe<Scalars['ID']>;
};
...
export type UpdateBearerInput = {
  data: InputMaybe<EditBearerInput>;
};

export type UpdateBearerPayload = {
  __typename?: 'updateBearerPayload';
  bearer: Maybe<Bearer>;
};

export type UpdateBlogCategoryInput = {
  data: InputMaybe<EditBlogCategoryInput>;
  where: InputMaybe<InputId>;
};
...
export type UpdateServiceCategoryInput = {
  data: InputMaybe<EditServiceCategoryInput>;
  where: InputMaybe<InputId>;
};
...
export type UpdateServiceInput = {
  data: InputMaybe<EditServiceInput>;
  where: InputMaybe<InputId>;
};

export type UpdateServicePageInput = {
  data: InputMaybe<EditServicePageInput>;
};

export type UpdateServicePagePayload = {
  __typename?: 'updateServicePagePayload';
  servicePage: Maybe<ServicePage>;
};
